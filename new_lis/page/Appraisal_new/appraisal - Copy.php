		...
		<script type="text/javascript">		
			function fnHitung() {
				...
				if (angka >= 1) {
				 ...
				 document.getElementById('value_likuidasi').value = tandaPemisahTitik(vsf);
				 return false; 
				}
			}
			function ntfHitung() {
				var angka = bersihPemisah(bersihPemisah(bersihPemisah(bersihPemisah(document.getElementById('value_bimbt').value)))); //input ke dalam angka tanpa titik
				if (angka >= 1) {
				 var sf = document.getElementById('value_smf').value;
				 vsf = parseInt(angka)*parseInt(sf)/100;
				 hasil = parseInt(angka)-parseInt(vsf);
				 document.getElementById('value_lf').value = tandaPemisahTitik(vsf);
				 
				var angka1 = bersihPemisah(bersihPemisah(bersihPemisah(bersihPemisah(document.getElementById('value_li').value))));
				
				
				hasil = parseInt(angka1) + parseInt(vsf);
				document.getElementById('totalcef').value = tandaPemisahTitik(hasil);
				 return false; 
				}
			}
			function ntiHitung() {
				...
				if (angka >= 1) {
				 ...
				 vsf = parseInt(angka)*parseInt(sf)/100;
				 hasil = parseInt(angka)-parseInt(vsf);
				 document.getElementById('value_li').value = tandaPemisahTitik(vsf);
				 return false; 
				}
			}
			function nttHitung() {
			...
			function savekendaraan(thecolid)
			{
				...
				{
					alert("Silahkan isi Officer 1.");
					$("#off1").focus();
				}
				else if (off2=="")
				{
					alert("Silahkan isi Officer 2.");
					$("#off2").focus();
				}
				else if (vopi=="")
				{
			...
			function savetnb(thecolid)
			{
				...
				else if (luas_bangunan=="")
				{
					alert("Silahkan isi luas bangunan.");
					$("#luas_bangunan").focus();
				}
				else if (off1=="")
				{
			...
			function hitungTanah(){
				var angka = bersihPemisah(bersihPemisah(bersihPemisah(bersihPemisah(document.getElementById('value_tnhpm').value)))); //input ke dalam angka tanpa titik
				if (angka >= 1) {
				 var sf = <?=$v_luas_tnh;?>;
				 vsf = parseInt(angka)*parseInt(sf);
				 hasil = vsf;
				 document.getElementById('value_tnht').value = tandaPemisahTitik(hasil);
				 return false; 
				}
			}
			
			function hitungBangunan(){
				var angka = bersihPemisah(bersihPemisah(bersihPemisah(bersihPemisah(document.getElementById('value_bimbpm').value)))); //input ke dalam angka tanpa titik
				if (angka >= 1) {
				var sf = document.getElementById('luas_bangunan').value;
				vsf = parseInt(angka)*parseInt(sf);
				hasil = vsf;
				document.getElementById('value_bimbt').value = tandaPemisahTitik(hasil);
				 
				var angka1 = bersihPemisah(bersihPemisah(bersihPemisah(bersihPemisah(document.getElementById('value_tnht').value))));
				var angka2 = bersihPemisah(bersihPemisah(bersihPemisah(bersihPemisah(document.getElementById('value_bimbt').value))));
				
				hasil = parseInt(angka1) + parseInt(angka2);
				document.getElementById('totalfisik').value = tandaPemisahTitik(hasil);
				return false; 
				}
			}
		</script>
						...
						<td style="width:50%" valign="top">
							<div>
								<table class="tbl100">
									...
									?>
									<tr>
										<td style="width:180px;">Officer <?=$x;?></td>
										<td style="width:250px;">
											<select id="off<?=$x?>" name="off<?=$x?>" class="nonmandatory">											
											<?php
                      ...
                      else
                      {
						  echo "<option value=''>-Select-</option>";
			                              ...
			                              order by tbl_se_user.user_name";
											...
											?>
												<option value='<?=$id?>' <?if($off==$id){echo "selected";}?>><?=$name;?></option>
											<?
												}
											}
											?>
							...
							<div>
								<table class="tbl100">
									...
									<tr>
										...
										<td style="width:250px;">
											<input type="text" id="value_tnhpm" name="value_tnhpm" maxlength="50" onkeydown="return numbersonly(this, event);" onkeyup="javascript:hitungTanah();" onkeypress="javascript:tandaPemisahTitik(this);"  style="width:100%;" value="<?echo number_format($value_tnhpm);?>"/>
										</td>
									</tr>
									<tr>
										<td style="width:180px;">Nilai Tanah Total</td>
										<td style="width:250px;">
											<input type="text" id="value_tnht" name="value_tnht" maxlength="50" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" onkeypress="return isNumberKey(event)" style="width:100%;" value="<?echo number_format($value_tnht);?>" readonly/>
										</td>
									</tr>
									<? if($list_type=="KUKPEDESTT"){?>
									<tr>
										<td style="width:180px;">CEF </td>
										<td style="width:250px;">
									...
									<tr>
										...
										<td style="width:250px;">
											<input type="text" id="luas_bangunan" name="luas_bangunan" maxlength="10" onkeypress="return isNumberKey(event)" style="width:20%;" value="<?echo $luas_bangunan;?>"/>
										</td>
									</tr>
									<tr>
										<td style="width:180px;">Nilai Bangunan  Per m<sup>2<sup></td>
										<td style="width:250px;">
											<input type="text" id="value_bimbpm" name="value_bimbpm" maxlength="50" onkeydown="return numbersonly(this, event);" onkeyup="javascript:hitungBangunan();" onkeypress="javascript:tandaPemisahTitik(this);"  style="width:100%;" value="<?echo number_format($value_bimbpm);?>"/>
										</td>
									</tr>
									<tr>
										<td style="width:180px;">Nilai Bangunan  Total</td>
										<td style="width:250px;">
											<input type="text" id="value_bimbt" name="value_bimbt" maxlength="50" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" onkeypress="return isNumberKey(event)" style="width:100%;" value="<?echo number_format($value_bimbt);?>" readonly/>
										</td>
									</tr>
									<? if($list_type=="KUKPEDESTT"){?>
									<tr>
									...
									<tr>
										...
										<td style="width:250px;">
											<input type="text" id="totalfisik" name="totalfisik" readonly style="width:100%;" value="<?=number_format($_nilai_total_fisik_agunan)?>"/>
										</td>
									</tr>
									<? if($list_type=="KUKPEDESTT"){?>
									<tr>
										...
										<td style="width:250px;">
											<input type="text" id="totalcef" name="totalcef" readonly style="width:100%;" value="<?=number_format($_nilai_total_cef_agunan)?>"/>
										</td>
									</tr>
									<?}?>
									<tr>
									...
									<tr>
										<td style="width:180px;">Officer <?=$x;?></td>
										<td style="width:250px;">
											<select id="off<?=$x?>" name="off<?=$x?>" <?if($x==1||$x==2){?> class="mandatory" <?}else{?>class="nonmandatory"<?}?>>
											<?php
//											$strsqlv01="SELECT * FROM appraisal_paramofficer";
                      if ($x == 1)
                      {
