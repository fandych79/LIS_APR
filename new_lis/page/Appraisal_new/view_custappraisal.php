                    ...
                    <tr>
                        <td colspan="2">
                            <table>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td><h3>FORM SIGN APPRAISAL (<? echo $custnomid ?>) </h3></td>
                                </tr>
								<tr>
                                    <td>&nbsp;</td>
...
if (sqlsrv_has_rows($sqlconv01)) {
    while ($rowsv01 = sqlsrv_fetch_array($sqlconv01, SQLSRV_FETCH_ASSOC)) {
        ...
        ?>
                                        ...
                                        <a href="view_custappraisal.php?custnomid=<?= $custnomid ?>&userwfid=<?= $userwfid ?>&userpermission=<?= $userpermission ?>&buttonaction=<?= $buttonaction ?>&userbranch=<?= $userbranch ?>&userregion=<?= $userregion ?>&userid=<?= $userid ?>&userpwd=<?= $userpwd ?>&jeniscol=<?= $m_cust_jeniscol ?>&col_id=<?= $m_col_id ?>"><? echo $col_name ?></A>&nbsp
                                        &nbsp
                                        <?
                                        }
                                        }
	...
	if(sqlsrv_has_rows($sqlconv01))
	{
        ...
        ?>
							...
							if($appjenis!=""){
								...
								<table class="tbl100">
                                        <tr>
                                            <td colspan="2"><h4>DATA CEF <?=$custnomid;?></h4></td>
                                        </tr>
