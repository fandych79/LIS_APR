...
?>		<div  style="padding-left : 10px;" style="padding-right : 10px;">
		<table width = "100%" align = "center" border = "0" >
			<tr>
				<td width=100% colspan = "3" style="font-size:20;" align="center"><strong>Tanah</strong></td>			
			</tr>
			</br>
			<tr>
			...
			<tr>
				...
				<td width=10%>:</td>
				<td width=50%><? echo $rowland['col_certdate']->format('Y/m/d');?></td>				
			</tr>
			<tr>
				<td width=40%>Tanggal Jatuh Tempo Sertifikat  </td>
				<td width=10%>:</td>
				<td width=50%><? echo $rowland['col_certdue']->format('Y/m/d');?></td>				
			</tr>
			<?php
			...
			<tr>
				...
				<td width=10%>:</td>
				<td width=50%><? echo $rowland['col_haktanggungantgl']->format('Y/m/d');?></td>				
			</tr>
			<?php
			...
			<tr>
				...
				<td width=10%>:</td>
				<td width=50%><? echo $rowland['col_safemargin'];?></td>				
			</tr>
			<tr>
				<td width=40%>Appraiser   </td>
				<td width=10%>:</td>
				<td width=50%><? echo $rowland['col_appraiser'];?></td>				
			</tr>
			<tr>
				<td width=40%>Tanggal Appraise  </td>
				<td width=10%>:</td>
				<td width=50%><? echo $rowland['col_appraisdate']->format('Y/m/d');?></td>				
			</tr>
			<tr>
				<td width=40%>Nilai Wajar  </td>
				<td width=10%>:</td>
				<td width=50%><? echo numberFormat($rowland['COL_NILAIWAJAR']);?></td>				
			</tr>
			<tr>
				<td width=40%>Nilai Likuidasi   </td>
				<td width=10%>:</td>
				<td width=50%><? echo numberFormat($rowland['COL_NILAILIKUIDASI']);?></td>				
			</tr>
			<?
				if ($rowland['COL_MK_CODE'] == "MK_M")
				{
					$mkcode = "Marketable";
				}
				else if ($rowland['COL_MK_CODE'] == "MK_T")
				{
