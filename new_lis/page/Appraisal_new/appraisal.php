...
if (sqlsrv_has_rows($sqlconv01)) {
    while ($rowsv01 = sqlsrv_fetch_array($sqlconv01, SQLSRV_FETCH_ASSOC)) {
        ...
        ?>
                                        ...
                                        <a href="appraisal.php?custnomid=<?= $custnomid ?>&userwfid=<?= $userwfid ?>&userpermission=<?= $userpermission ?>&buttonaction=<?= $buttonaction ?>&userbranch=<?= $userbranch ?>&userregion=<?= $userregion ?>&userid=<?= $userid ?>&userpwd=<?= $userpwd ?>&jeniscol=<?= $m_cust_jeniscol ?>&col_id=<?= $m_col_id ?>"><? echo $col_name ?></A>&nbsp
                                        &nbsp
                                        <?
                                        }
                                        }
								...
								<table class="tbl100">
                                        ...
                                        <tr>
										 ...
										 <tr>
                                            ...
                                            <td>:</td>
											<td>
												<textarea id="keterangan" name="keterangan" style="width:100%;"><?=$keterangan?></textarea>
											</td>
                                        </tr>
										<?php
