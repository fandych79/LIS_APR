	...
	<head>
		...
		<script type="text/javascript">
			...
			function changeform(theid)
			{
				...
				document.frm.action = "./appraisaldoc.php";
				document.frm.submit();
			}
					...
					<tr>
						<td colspan="2">
							<table>
								...
								<tr>
									<td>&nbsp;</td>
									<td><h3>DATA APPRAISAL (<? echo $custnomid ?>) &nbsp &nbsp &nbsp <a href="javascript:refreshhtml()">refresh</a></h3></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						...
						<td style="width:50%" valign="top">
							<div>
								<table class="tbl100">
									<tr>
										<td colspan="2"><h4><A HREF="javascript:uploadDocument('<? echo $linkdmI ?>')">DOCUMENT UPLOAD : KENDARAAN</A></h4></td>
									</tr>
<?
    $urut = 0;
		$strsqlv01="SELECT * FROM Tbl_DocCol WHERE doc_col_type = '$appjenis'";
					...
					<tr>
						...
						<td style="width:50%" valign="top">
							<div>
								<table class="tbl100">
									<tr>
										<td colspan="2"><h4><A HREF="javascript:uploadDocument('<? echo $linkdmI ?>')">DOCUMENT UPLOAD : TANAH DAN BANGUNAN</A></h4></td>
									</tr>
<?
    $urut = 0;
		$strsqlv01="SELECT * FROM Tbl_DocCol WHERE doc_col_type = '$appjenis'";
					...
					<tr>
						...
						<td style="width:50%" valign="top">
							<div>
								<table class="tbl100">
									<tr>
										<td colspan="2"><h4><A HREF="javascript:uploadDocument('<? echo $linkdmI ?>')">DOCUMENT UPLOAD : TANAH</A></h4></td>
									</tr>
<?
    $urut = 0;
		$strsqlv01="SELECT * FROM Tbl_DocCol WHERE doc_col_type = '$appjenis'";
