				...
				<table border="1" style ="width:900px; border-color:black;" align="center" id="tblform">
					...
					<tr>
						<td align="center" colspan="2" style="font-size:12pt;">
							...
							<tr>
								<td colspan="2">
									Pada hari ini <input type="text" id="tanggal_beritaacara" name="tanggal_beritaacara" maxlength="200" value="<?=$tanggal_beritaacara;?>" style="width:100px;" class="tanggal" required/>
							...
							<tr>
								<td width="30%" style="padding-left:20px;padding-top:5px;">
									1. <input type="text" id="nama_petugas1" name="nama_petugas1" maxlength="50" value="<?php echo $nama_petugas1;?>" style="width:200px;" required/>
								</td>
								<td width="70%">
									<input type="text" id="jabatan_petugas1" name="jabatan_petugas1" maxlength="50" value="<?php echo $jabatan_petugas1;?>"  style="width:300px;" required/>
								</td>
							</tr>
							<tr>
								<td width="30%" style="padding-left:20px;padding-top:5px;">
									2. <input type="text" id="nama_petugas2" name="nama_petugas2" maxlength="50" value="<?php echo $nama_petugas2;?>" style="width:200px;" required/>
								</td>
								<td width="70%">
									<input type="text" id="jabatan_petugas2" name="jabatan_petugas2" maxlength="50" value="<?php echo $jabatan_petugas2;?>"  style="width:300px;" required/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2"  style="padding-top:20px;padding-bottom:20px;">
									...
									<tr>
										...
										<td><select type="text" id="kesiapan<?=$detail_code?>" name="kesiapan<?=$detail_code?>"" maxlength="250" value="" style="width:100%;" >
											<option value="Ada" <?if($kesiapan=="Ada"){echo "selected";}?>>Ada</option>
											<option value="Tidak" <?if($kesiapan=="Tidak"){echo "selected";}?>>Tidak</option>
										</select>
										</td>
										<td><input type="text" id="kondisi<?=$detail_code?>" name="kondisi<?=$detail_code?>"" maxlength="250" value="<?=$kondisi?>" style="width:100%;" class="nonmandatory"/></td>
										<td><input type="text" id="catatan<?=$detail_code?>" name="catatan<?=$detail_code?>"" maxlength="250" value="<?=$catatan?>" style="width:100%;" class="nonmandatory"/></td>
										<td><input type="text" id="keterangan<?=$detail_code?>" name="keterangan<?=$detail_code?>"" maxlength="250" value="<?=$keterangan?>" style="width:100%;" class="nonmandatory"/></td>
									</tr>
									<?
							...
							<tr>
								<td colspan="2" align="center">
									<button id="submit" name="submit" class="blue" type="submit">Submit Form</button>
								</td>
							</tr>
							</table>
						</td>
