	...
	<head>
		...
		<script type="text/javascript">
			...
			function changeform(theid)
			{
				...
				document.frm.action = "./appraisal_view.php";
				document.frm.submit();
			}
						...
						<td style="width:50%" valign="top" rowspan="2">
							<table class="tbl100">
								...
								<tr>
									<td style="width:300px;">Luas Tanah</td>
									<td style="width:10px;">:</td>
									<td style="width:500px;"><?php echo $v_luas_tnh;?></td>
								</tr>
								<tr>
									<td style="width:300px;">Panjang Tanah</td>
									<td style="width:10px;">:</td>
									<td style="width:500px;"><?php echo $v_pan_tnh;?></td>
								</tr>
								<tr>
									<td style="width:300px;">Lebar Tanah</td>
									<td style="width:10px;">:</td>
									<td  style="width:500px;"><?php echo $v_leb_tnh;?></td>
								</tr>
								<tr>
									<td style="width:300px;">Sisi Utara</td>
									<td style="width:10px;">:</td>
