							...
							?>
											...
											if(sqlsrv_has_rows($sqlconv01))
											{
												while($rowsv01 = sqlsrv_fetch_array($sqlconv01, SQLSRV_FETCH_ASSOC))
												{
													...
													echo "<td width=\"30%\">Jenis Kendaraan </td>";
													echo "<td width=\"50%\">".$rowsv01['jenis_kendaraan']." </td>";
													echo "</tr>";
													echo "<tr>";
													echo "<td width=\"30%\">Tahun Produksi </td>";
													echo "<td width=\"50%\">".$rowsv01['tahun_produksi']." </td>";
													echo "</tr>";
													echo "<tr>";
													echo "<td width=\"30%\">Tahun Pemakaian </td>";
													echo "<td width=\"50%\">".$rowsv01['tahun_pemakaian']." </td>";
													echo "</tr>";
													echo "<tr>";
													echo "<td width=\"30%\">Harga Jual </td>";
													echo "<td width=\"50%\">".number_format($rowsv01['harga_jual'])." </td>";
													echo "</tr>";
