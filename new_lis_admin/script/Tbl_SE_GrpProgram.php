...
require ("../lib/open_con.php");
      ...
      $tsql = "DELETE FROM Tbl_SE_GrpProgram
   					WHERE grp_code='$thecode'";
...
require ("../lib/open_con.php");
   ...
   $tsql = "SELECT COUNT(*) as b FROM Tbl_SE_GrpProgram
   					WHERE grp_code='$ctext'";
   $cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
   $params = array(&$_POST['query']);
   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE Tbl_SE_GrpProgram SET grp_name = '$ntext',
											grp_urut = '$utext',
											grp_flag = '$ftext',
											grp_active = '$atext',
											grp_create_userid = '$userid',
											grp_create_time = '$dtext'
											where grp_code = '$ctext'";
   }
   else
   {
      $tsql = "INSERT INTO Tbl_SE_GrpProgram VALUES('$ctext','$ntext','$utext','$ftext','$atext','$userid','$dtext')";
   }
...
?>
        ...
        function cekDel(thecode)
        {
           ...
           document.formsubmit.action = "./Tbl_SE_GrpProgram.php";
   	      ...
   	      <table width="760" border=0 cellpadding=0 cellspacing=0>
			  ...
			  <tr>
				<td style="padding-bottom:10px;padding-top:10px;">
					...
					Urut : <input type="text" name="utext" id="utext" value="<?=$turut?>" style="width:40px;margin-right:20px;">
					Flag : <input type="text" name="ftext" id="ftext" value="<?=$tflag?>" style="width:40px;margin-right:20px;">
					Active : <input type="text" name="atext" id="atext"  value="<?=$tactive?>"style="width:40px;margin-right:20px;">
							...
							<center>
								...
								<table class="tablein" border="1">
									<tr align="center" height="20px">
										...
										<th width="258px">Name</th>
										<th width="88px">Urut</th>
										<th width="89px">Flag</th>
										<th width="84px">Active</th>
										<th width="117px"></th>
									</tr>
								</table>
								</div>
...
<?
									$strsql="select * from Tbl_SE_GrpProgram";
									$cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
