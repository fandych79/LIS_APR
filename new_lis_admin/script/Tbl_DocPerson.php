...
require ("../lib/open_con.php");
      ...
      $tsql = "DELETE FROM Tbl_DocPerson
...
require ("../lib/open_con.php");
   ...
   $tsql = "SELECT COUNT(*) as b FROM Tbl_DocPerson
   					WHERE doc_id='$ctext'";
   $cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
   $params = array(&$_POST['query']);
   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE Tbl_DocPerson SET doc_name = '$ntext',
   ...
   {
      $tsql = "INSERT INTO Tbl_DocPerson VALUES('$ctext','$ntext','$userid','$dtext','$ftext','$atext','$stext')";
   }
...
?>
        ...
        function cekDel(thecode)
        {
           ...
           document.formsubmit.action = "./Tbl_DocPerson.php";
   	      ...
   	      <table width="760" border=0 cellpadding=0 cellspacing=0>
			  ...
			  <tr>
				<td style="padding-bottom:10px;padding-top:10px;">
					Code : <input type="text" name="ctext" id="ctext" value="<?=$tcode?>" style="width:80px;margin-right:20px;">
					...
					Segmen : <input type="text" name="stext" id="stext" value="<?=$tsegmen?>" style="width:50px;margin-right:20px;">
							...
							<center>
								...
								<table class="tablein" border="1">
									<tr align="center" height="20px">
										<th width="98px">Doc Code</th>
										<th width="288px">Doc Name</th>
										<th width="67px">Doc Flag</th>
										<th width="66px">Doc Active</th>
										<th width="76px">Doc Segmen</th>
										<th width="129px"></th>
									</tr>
								</table>
								</div>
...
<?
									$strsql="select * from Tbl_DocPerson";
									$cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
