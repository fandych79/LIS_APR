...
<?
	if ($act == "editdata")
	{
    $get_user_active = "SELECT * FROM se_user WHERE user_id = '$theuserid'";
    $db_security->executeQuery($get_user_active);
    $get_user_active = $db_security->lastResults;

    $user_active = $get_user_active[0]['user_active'];
...
#							     $vartemp2 .= "\"'" . $row2['program_code'] . ":" . $row2['program_code'] . ":" . $row2['program_code'] . ":" . "~" . "'\",";
   	      ...
   	      sqlsrv_free_stmt( $sqlConn2 );
				$vartemp2 .= "~'\",";
				$vartemp3 .= "~'\",";
        $vartemp .= $vartemp3 . $vartemp2 . "'','".$user_active."');";
?>
				    <? echo $vartemp; ?>
...
?>
        function viewDetail()
        {
        	  goNew();
	   	      ...
	   	      if (selectedArray[17].length > 3)
	   	      {
	   		    ...
	   		    eval("document.formsubmit.check_proc_code.value=" + selectedArray[6]);
	   		    eval("document.formsubmit.back_check.value=" + selectedArray[6]);
            ...
            //eval("document.formsubmit.newusertemp.value=" + selectedArray[23]);
            eval("document.formsubmit.backusertemp.value=" + selectedArray[23]);
        }
        function goNew()
        {
	   		    ...
	   		    document.formsubmit.check_proc_code.value="";
            ...
            //document.formsubmit.newusertemp.value="1";
        }
        ...
        function viewProcCode(theformname,theformfield,thefielddest,thewindow,thedetail)
        {
           document.formsubmit.target = thewindow;
           document.formsubmit.act.value = "viewProcCode";
           document.formsubmit.utilwindow.value = thewindow;
           document.formsubmit.utilformname.value = theformname;
           document.formsubmit.utilfielddest.value = thefielddest;
           document.formsubmit.utilformfield.value = theformfield;
        ...
        function goSave(theid)
        {
           ...
           {
               cekHistory("User Name : ",document.formsubmit.backuseremail.value,document.formsubmit.newuseremail.value);
           }
           ...
           if (document.formsubmit.check_proc_code.value == "")
           {
               alert("Please fill User Proc Code");
               document.formsubmit.check_proc_code.focus();
               return false;
           }
           else
           {
               cekHistory("User Proc Code : ",document.formsubmit.back_check.value,document.formsubmit.check_proc_code.value);
           }
           ...
           if (document.formsubmit.newusertemp.value == "")
           {
               alert("Please fill Status User Temporary");
               document.formsubmit.newusertemp.focus();
               return false;
           }
           else
           {
               cekHistory("User Temporary : ",document.formsubmit.backusertemp.value,document.formsubmit.newusertemp.value);
           }
...
?>
   	  	      		   	      	...
   	  	      		   	      	<tr>
   	  	      		   	      		<td width=30% align=right valign=top>
                                  <A HREF="javascript:viewProcCode('formsubmit','check_proc_code','check_proc_code','mediumwindow','N')"><font face=Arial size=2>Proc Code</font></A> &nbsp
   	  	      		   	      		</td>
   	  	      		   	      		<td width=70% align=left valign=top>
 	  	      		   	      			  <input type=hidden name=back_check>
                                  <textarea name="check_proc_code" id="check_proc_code" rows=3 cols=40></textarea>
   	  	      		   	      		</td>
   	  	      		   	      	</tr>
   	  	      		   	      	<tr>
   	  	      		   	      		<td width=30% align=right valign=top>
...
<?
   ...
   if(sqlsrv_has_rows($sqlConn))
   {
      ...
      {
?>
   	  	      			         <option value='<? echo $row['level_code']; ?>'>[ <?php echo $row['level_flag']?> ] <? echo $row['level_code']; ?> - <? echo $row['level_name']; ?></option>
<?
      }
   }
   sqlsrv_free_stmt( $sqlConn );
                              ...
                              <!--
   	  	      		   	      	<tr>
   	  	      		   	      		...
   	  	      		   	      		<td width=70% align=left valign=top>-->
   	  	      		   	      			...
   	  	      		   	      			<input type=hidden name=newuserpicture size=30 maxlength=30>
   	  	      		   	      		<!--</td>
   	  	      		   	      	</tr>
   	  	      		   	      	<tr>
   	  	      		   	      		<td width=30% align=right valign=top>
                                  ...
                                  <input type=hidden name=newuseraocode>
...
?>
                                  ...
                                  <input type=hidden name=newuserchild>
                                  ...
                                  <input type=hidden name=newdownlinestatus>
...
?>
                              ...
                              <tr>
                                <td width=30% align=right valign=top>
                                  <font face=Arial size=2>Status User Temporary</font> &nbsp
                                </td>
                                <td width=70% align=left valign=top>
                                  <input type=hidden name=backusertemp>
                                  <select name=newusertemp style='width: 70mm'>
<?
                                  $seltidak="";
                                  $selya="";
                                  if($user_active=="" || $user_active=="1")
                                  {
                                    $seltidak = "selected=selected";
                                  }else if($user_active=="9"){
                                    $selya = "selected=selected";
                                  }
?>
                                    <option value='1' <?php echo $seltidak;?>>Tidak</option>
                                    <option value='9' <?php echo $selya;?>>Ya</option>
                                  </select>
                                </td>
                              </tr>
   	  	      		   	      	<tr>
