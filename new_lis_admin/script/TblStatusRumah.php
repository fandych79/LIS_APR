...
require ("../lib/open_con.php");
      ...
      $tsql = "DELETE FROM TblStatusRumah
...
require ("../lib/open_con.php");
   ...
   $tsql = "SELECT COUNT(*) as b FROM TblStatusRumah
   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE TblStatusRumah SET status_name = '$ntext',
											status_flag = '$ftext',
											status_active = '$atext',
   ...
   {
      $tsql = "INSERT INTO TblStatusRumah VALUES('$ctext','$ntext','$ftext','$atext','$userid','$dtext')";
   }
...
?>
        ...
        function cekDel(thecode)
        {
           ...
           document.formsubmit.action = "./TblStatusRumah.php";
...
<?
	...
	$tsql = "SELECT * FROM TblStatusRumah
							...
							<center>
								...
								<table class="tablein" border="1">
									<tr align="center" height="20px">
										<th width="100px">Status Code</th>
										<th width="293px">Status Name</th>
										<th width="100px">Status Flag</th>
										<th width="100px">Status Active</th>
										<th width="134px"></th>
									</tr>
								</table>
								</div>
...
<?
									$strsql="select * from TblStatusRumah";
									$cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
