        ...
        {        
        	  ...
        	  goNew();
				...
				eval("document.formsubmit.newrulesflow.value=" + selectedArray[11]);
	   		    ...
	   		    eval("document.formsubmit.backparamdoc.value=" + selectedArray[13]);
				eval("document.formsubmit.newparamdoc.value=" + selectedArray[13]);
...
?>
   	  	      		   	      	...
   	  	      		   	      	<tr>
   	  	      		   	      		<td width=30% align=right valign=top>
   	  	      		   	      			<A HREF="javascript:viewFlow('formsubmit','newprevflow','newprevflow','mediumwindow','N')"><font face=Arial size=2>Prev FLOW</font> &nbsp</A>
   	  	      		   	      		</td>
   	  	      		   	      		<td width=70% align=left valign=top>
