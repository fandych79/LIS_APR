...
function CEKJOB()
{
  ...
  if ($loguserid != "")
  {
  	 $kondisiuserid = "AND (Tbl_AO.ao_code like '%$loguserid%' or Tbl_AO.ao_name like '%$loguserid%')";
  }
  ...
  if ($logbranch != "")
  {
  	 ...
  	 {
  	    $kondisibranch = "AND Tbl_AO.ao_branch_code = '$logbranch'";
  	 }
  }
?>
...
$line = "NO" . chr(9) . "AO CODE" . chr(9) . "AO NAME" . chr(9) . "AO USER ID" . chr(9) . "BRANCH CODE" . chr(9) . "BRANCH"  . chr(9) . "AO HP NUMBER"  . chr(9) . "AO NIK"  . chr(9) . "AO TL"  . chr(9) ."\n";
	    fwrite($FILEOMR,$line);
		}
		else
		{
?>
      	                	      <tr>
      	                	         ...
      	                	         <td width=10% align=center valign=top>
      	                	            <font face=Arial size=2><b>AO CODE</b></font>
      	                	         </td>
      	                	         <td width=30% align=center valign=top>
      	                	            <font face=Arial size=2><b>AO NAME</b></font>
      	                	         </td>
                                     <td width=30% align=center valign=top>
      	                	            <font face=Arial size=2><b>AO USER ID</b></font>
      	                	         </td>
                                     <td width=10% align=center valign=top>
      	                	            <font face=Arial size=2><b>BRANCH CODE</b></font>
      	                	         </td>
      	                	         <td width=10% align=center valign=top>
      	                	            <font face=Arial size=2><b>BRANCH</b></font>
      	                	         </td>
      	                	         <td width=10% align=center valign=top>
      	                	            <font face=Arial size=2><b>AO HP NUMBER</b></font>
      	                	         </td>
      	                	         <td width=10% align=center valign=top>
                                     <font face=Arial size=2><b>AO NIK</b></font>
                                     </td>
      	                	         <td width=10% align=center valign=top>
                                     <font face="Arial" size="2"><b>AO TL</b></font>
                                     </td>
      	                	      </tr>
<?
		}

	$tsql = "SELECT Tbl_AO.ao_code, Tbl_AO.ao_name,
			Tbl_AO.ao_branch_code, Tbl_AO.ao_hp_number,
			Tbl_AO.ao_nik, Tbl_AO.ao_tl
   		FROM Tbl_AO, Tbl_Branch
   		WHERE Tbl_AO.ao_branch_code=Tbl_Branch.branch_code
   		$kondisiuserid
   		$kondisibranch
...
$ao_user_id_txt = "Not Registered";
$ao_user_id = "<font color='#FF0000'>Not Registered</font>";
$tsql2 = "select user_id  
from Tbl_se_user 
where user_ao_code = '$row[0]' and user_branch_code = '$row[2]'";
$cursorType2 = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
$params2 = array(&$_POST['query']);
...
sqlsrv_free_stmt( $sqlConn2 );
					...
					if ($logoutput == "txt")
					{
$line = $urut . chr(9) . $row[0] . chr(9) . $row[1] . chr(9) . $ao_user_id_txt . chr(9) . $row[2] . chr(9) . $branchname . chr(9) . $row[3] . chr(9) . $row[4]  . chr(9) . $row[5]  . chr(9) . "\n";
	    					fwrite($FILEOMR,$line);
					}
					else
					{
?>
      	                	      <tr>
      	                	         <td width=5% align=right valign=top>
      	                	            <font face=Arial size=2><? echo $urut; ?>.&nbsp;</font>
      	                	         </td>
      	                	         <td width=10% align=center valign=top>
                                     ...
                                     <td width=10% align=center valign=top>
      	                	         ...
      	                	         <td width=30% align=left valign=top>
      	                	            <font face=Arial size=2><? echo $ao_user_id; ?></font>
      	                	         </td>
                                     <td width=10% align=center valign=top>
      	                	         ...
      	                	         <td width=10% align=center valign=top>
      	                	            <font face=Arial size=2><? echo $row[3]; ?></font>
      	                	         </td>
      	                	         <td width=10% align=right valign=top>
                                     <font face=Arial size=2><? echo $row[4]; ?></font>
                                     </td>
      	                	         <td width=10% align=right valign=top>
                                     <font face=Arial size=2><? echo $row[5]; ?></font>
                                     </td>
      	                	      </tr>
<?
					}
