...
<table width="960" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th scope="col" colspan="5">HISTORY ASSIGNMENT</th>
  </tr>
  <tr>
...
<table width="960" border="1" cellspacing="0" cellpadding="0">
  ...
  <?
	...
	$tsql = "select * from tbl_assignment_history_log where assignment_status = 'H' and flag = '0'";
	...
	if(sqlsrv_has_rows($sqlConn))
	{
		...
		while( $row = sqlsrv_fetch_array( $sqlConn, SQLSRV_FETCH_ASSOC))
		{
            ...
            <td align="center">
            <? echo $row['assignment_date']->format("d-M-Y h:m:s");?>
