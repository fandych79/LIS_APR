...
require ("../lib/open_con.php");
      ...
      $tsql = "DELETE FROM Tbl_ManageHEAD
   					WHERE tbl_name='$thecode'";
...
require ("../lib/open_con.php");
   ...
   $tsql = "SELECT COUNT(*) as b FROM Tbl_ManageHEAD
   					WHERE tbl_name='$ctext'";
   $cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
   $params = array(&$_POST['query']);
   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE Tbl_ManageHEAD SET tbl_desc = '$ntext',
											tbl_urut = '$ftext'
											where tbl_name = '$ctext'";
   }
   else
   {
      $tsql = "INSERT INTO Tbl_ManageHEAD VALUES('$ctext','$ntext','$ftext')";
   }
...
?>
        ...
        function cekDel(thecode)
        {
           ...
           document.formsubmit.action = "./Tbl_ManageHEAD.php";
        ...
        function cekSave()
        {
			...
			var vurut = document.formsubmit.ftext;
			...
			else if(vurut.value.trim().length == 0){
...
<?
	...
	$tsql = "SELECT * FROM Tbl_ManageHEAD
					WHERE tbl_name='$thekey'";
	$cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
	$params = array(&$_POST['query']);
   	      ...
   	      <table width="760" border=0 cellpadding=0 cellspacing=0>
			  ...
			  <tr>
				<td style="padding-bottom:10px;padding-top:10px;">
					Name : <input type="text" name="ctext" id="ctext" value="<?=$tcode?>" style="width:70px;margin-right:20px;">
					Desc : <input type="text" name="ntext" id="ntext" value="<?=$tname?>" style="width:180px;margin-right:20px;">
					Urut : <input type="text" name="ftext" id="ftext" value="<?=$tflag?>" style="width:70px;margin-right:20px;">
							...
							<center>
								...
								<table class="tablein" border="1">
									<tr align="center" height="20px">
										...
										<th width="325px">Description</th>
										<th width="111px">Urut</th>
										<th width="150px"></th>
									</tr>
								</table>
								</div>
...
<?
									$strsql="select * from Tbl_ManageHEAD";
									$cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
