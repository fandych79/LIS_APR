...
require ("../lib/open_con.php");
      ...
      $tsql = "DELETE FROM TblPendidikan
   					WHERE edu_code='$thecode'";
...
require ("../lib/open_con.php");
   ...
   $tsql = "SELECT COUNT(*) as b FROM TblPendidikan
   					WHERE edu_code='$ctext'";
   $cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
   $params = array(&$_POST['query']);
   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE TblPendidikan SET edu_name = '$ntext',
											edu_flag = '$ftext',
											edu_active = '$atext',
											edu_create_userid = '$userid',
											edu_create_time = '$dtext'
											where edu_code = '$ctext'";
   }
   else
   {
      $tsql = "INSERT INTO TblPendidikan VALUES('$ctext','$ntext','$ftext','$atext','$userid','$dtext')";
   }
...
?>
        ...
        function cekDel(thecode)
        {
           ...
           document.formsubmit.action = "./TblPendidikan.php";
...
<?
	...
	$tsql = "SELECT * FROM TblPendidikan
					WHERE edu_code='$thekey'";
	$cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
	$params = array(&$_POST['query']);
...
<?
									$strsql="select * from TblPendidikan";
									$cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
