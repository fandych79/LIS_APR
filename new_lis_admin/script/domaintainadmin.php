  ...
  if ($newuserlimit == "")
  {
   ...
   else
   {
      $tsql = "INSERT INTO OTO_Tbl_SE_User VALUES('$userid',convert(varchar,getdate(),121),'$logdesc',
      				  ...
      				  '2011-09-09 12:00:00','Y','$newuserlimit','$newuserpicture','$newuseraocode','$newuserchild','$varreturn')";
			$logdesc = "ADD $newuserid //" . $actionhistory;
   }
   	      ...
   	      <table width="760" border=0 cellpadding=0 cellspacing=0>
   	      	<tr>
   	      		<td width=100% align=left valign=top>
     	   	       ...
     	   	       <A HREF="javascript:changeMenu('../maintainadmin.php')"><font face=Arial size=2>Back To Maintain Admin</font></A>
   	      		</td>
   	      	</tr>
   	      </table>
   	      <BR><BR>
