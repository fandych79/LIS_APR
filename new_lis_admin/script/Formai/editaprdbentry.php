...
<BODY>
<?php
//if (isset($_POST["Texcustnomid"]) && $_POST["Texcustnomid"]!="")  { // jika querystring tbl ada
...
?>
	...
	<td>
		...
		<tr>
				...
				<td style="padding-left : 10px;" align="left"><a href="editaprdbentry.php">EDIT</a> </td>
		</tr>
		<tr>
...
<?php
	...
	<td>
		...
		<table width = 750 border="0" align="center">
			...
			<tr>
				<td>
					<?php $id = isset($_POST['id']) ? $_POST['id'] : 1; ?>
					...
					<div class="Pages" style="width: 750px; height: 500px; background-color:#FFF;">
						  <div class="Page" style="display: <?=($id == 1) ? 'block' : 'none';?>"><div class="Pad"><? include("editland.php"); ?></div></div>
						  <div class="Page" style="display: <?=($id == 2) ? 'block' : 'none';?>"><div class="Pad"><? include("editbuilding.php");?></div></div>
						  <div class="Page" style="display: <?=($id == 3) ? 'block' : 'none';?>"><div class="Pad"><? include("editvehicle.php");?></div></div>
						</div>
					</div>
