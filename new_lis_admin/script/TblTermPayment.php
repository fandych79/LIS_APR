...
require ("../lib/open_con.php");
      ...
      $tsql = "DELETE FROM TblTermPayment
   					WHERE term_code='$thecode'";
...
require ("../lib/open_con.php");
   ...
   $tsql = "SELECT COUNT(*) as b FROM TblTermPayment
   					WHERE term_code='$ctext'";
   $cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
   $params = array(&$_POST['query']);
   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE TblTermPayment SET term_name = '$ntext',
											term_flag = '$ftext',
											term_active = '$atext',
											term_create_userid = '$userid',
											term_create_time = '$dtext'
											where term_code = '$ctext'";
   }
   else
   {
      $tsql = "INSERT INTO TblTermPayment VALUES('$ctext','$ntext','$ftext','$atext','$userid','$dtext')";
   }
...
?>
        ...
        function cekDel(thecode)
        {
           ...
           document.formsubmit.action = "./TblTermPayment.php";
