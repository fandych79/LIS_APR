...
<form id="formsubmit" name="formsubmit" method="post" action="do_manage_assignment_replace_apps.php">
<table width="960" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th width="5%" scope="col"><a href="javascript:history.back()">Back</a></th>
    <th width="5%" scope="col">&nbsp;</th>
    <th width="80%" scope="col">REPLACE APPS <font color="#0066FF"><? echo $apps_ID;?></font> USER ASSIGNMENT</th>
    <th width="5%" scope="col">&nbsp;</th>
    <th width="5%" scope="col">&nbsp;</th>
  </tr>
  <tr>
    ...
    <td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>Application ID : <font color="#0066FF"><? echo $apps_ID;?> </font></td>
            <td><input type="hidden" id="hid_apps" name="hid_apps" value="<? echo $apps_ID;?>">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>Original User : <font color="#0066FF"><? echo $userid;?> - <? echo $userName;?> - <? echo $paramUserLevel[$userLevel];?></font>&nbsp;</td>
