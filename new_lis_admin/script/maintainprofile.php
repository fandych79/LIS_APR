...
?>
        function viewDetail()
        {
        	  goNew();
	   	      var selectedArray = eval(document.formsubmit.updcode.options[document.formsubmit.updcode.selectedIndex].value);
	   		    ...
	   		    eval("document.formsubmit.backprofileid.value=" + selectedArray[0]);
	   		    eval("document.formsubmit.newprofilename.value=" + selectedArray[1]);
	   		    eval("document.formsubmit.backprofilename.value=" + selectedArray[1]);
            vardata = selectedArray[2].split('|');
	   		    document.formsubmit.newusertrustee.value = vardata[0].substring(1);
	   		    document.formsubmit.backusertrustee.value = vardata[0].substring(1);
	   		    document.formsubmit.newuserother.value = vardata[1].substring(0,vardata[1].length-1);
	   		    document.formsubmit.backuserother.value = vardata[1].substring(0,vardata[1].length-1);
        }
        function goNew()
        {
        ...
        function goSave()
        {
        	 document.formsubmit.actionhistory.value = "";
				   ...
				   if (!cekSpecialChar("Profile ID","document.formsubmit.newprofileid"))
				   {
				   	  return false;
				   }
				   ...
				   {
				   	   cekHistory("Profile Name : ",document.formsubmit.backprofilename.value,document.formsubmit.newprofilename.value);
				   }
				   ...
				   {
				   	   cekHistory("Trustee Entry : ",document.formsubmit.backusertrustee.value,document.formsubmit.newusertrustee.value);
				   }
				   ...
				   {
				   	   cekHistory("Trustee Other : ",document.formsubmit.backuserother.value,document.formsubmit.newuserother.value);
				   }
   	  	      		   	      ...
   	  	      		   	      <table width=100% border=0 cellpadding=2 cellspacing=2>
   	  	      		   	      	<tr>
   	  	      		   	      		...
   	  	      		   	      		<td width=70% align=left valign=top>
   	  	      		   	      			<input type=text name=newprofileid size=20 maxlength=5>
   	  	      		   	      			<input type=hidden name=backprofileid>
   	  	      		   	      		</td>
   	  	      		   	      	</tr>
   	  	      		   	      	<tr>
   	  	      		   	      		<td width=30% align=right valign=top>
   	  	      		   	      			<font face=Arial size=2>Name &nbsp</font>
   	  	      		   	      		</td>
   	  	      		   	      		<td width=70% align=left valign=top>
   	  	      		   	      			<input type=text name=newprofilename size=30 maxlength=50>
   	  	      		   	      			<input type=hidden name=backprofilename>
   	  	      		   	      		</td>
   	  	      		   	      	</tr>
   	  	      		   	      	<tr>
   	  	      		   	      		<td width=30% align=right valign=top>
