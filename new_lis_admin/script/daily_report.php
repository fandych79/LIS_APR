...
<form action="./do_daily_report.php" method="get">
...
<table style="background-color:#FFF;"width="500"  cellpadding="0" cellspacing="0" border="1" align="center" bordercolor="#4476b3" bordercolorlight="#000000" bordercolordark="#ffffff" >
  ...
  <tr>
    <td style="padding-left:5px;">Progress</td>
    <td style="padding-left:5px;"><select name="progress">
						<option value="A">--ALL--</option>
						<?
							$sql_query = "SELECT * FROM Tbl_workflow";
