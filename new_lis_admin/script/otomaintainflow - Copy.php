<?php
  ...
  $userprogramact="otomaintainflow.php";
...
function MAIN()
{
  ...
  $userpwd=$_POST['userpwd'];
  $paramtitle="WORKFLOW";
  $paramaction="domaintainflow.php";
  $paramtable="OTO_Tbl_Workflow";
  $paramfield="wf_id";
   	      ...
   	      <table style="background-color:#FFF;"width="760"  cellpadding="0" cellspacing="0" border="0" align="center" bordercolor="#4476b3" bordercolorlight="#000000" bordercolordark="#ffffff" >
   	      	...
   	      	<tr>
   	      		<td width=100% align=center valign=top>
   	  	      	 <font face=Arial size=3><b>OTORISASI WORKFLOW</b></font>
   	      		</td>
   	      	</tr>
   	      </table>
   	      <BR><BR>
...
<?
   $thedata = "";
   $tsql = "SELECT system_userid,system_time,system_desc, wf_id
