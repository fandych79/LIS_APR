...
require ("../lib/open_con.php");
      ...
      $tsql = "DELETE FROM Tbl_Region
   					WHERE region_code='$thecode'";
...
require ("../lib/open_con.php");
   ...
   $tsql = "SELECT COUNT(*) as b FROM Tbl_Region
   					WHERE region_code='$ctext'";
   $cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
   $params = array(&$_POST['query']);
   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE Tbl_Region SET region_name = '$ntext',
											region_flag = '$ftext',
											region_active = '$atext',
											region_create_userid = '$userid',
											region_create_time = '$dtext'
											where region_code = '$ctext'";
   }
   else
   {
      $tsql = "INSERT INTO Tbl_Region VALUES('$ctext','$ntext','$ftext','$atext','$userid','$dtext')";
   }
...
?>
        ...
        function cekDel(thecode)
        {
           ...
           document.formsubmit.action = "./Tbl_Region.php";
...
<?
	...
	if(sqlsrv_has_rows($sqlConn))
	{
		...
		while( $row = sqlsrv_fetch_array( $sqlConn, SQLSRV_FETCH_ASSOC))
		{
			$tcode = $row['region_code'];
			$tname = $row['region_name'];
			$tflag = $row['region_flag'];
			$tactive = $row['region_active'];
		}
	}
	//echo $tcode;
							...
							<center>
								...
								<table class="tablein" border="1">
									<tr align="center" height="20px">
										<th width="100px">Region Code</th>
										<th width="293px">Region Name</th>
										<th width="100px">Region Flag</th>
										<th width="100px">Region Active</th>
										<th width="134px"></th>
									</tr>
								</table>
								</div>
