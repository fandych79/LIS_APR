...
require ("../lib/open_con.php");
   ...
   $tsql = "SELECT COUNT(*) as b FROM Tbl_DocAdmin
   					WHERE doc_id='$ctext'";
   $cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
   $params = array(&$_POST['query']);
   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE Tbl_DocAdmin SET doc_name = '$ntext',
   ...
   {
      $tsql = "INSERT INTO Tbl_DocAdmin VALUES('$ctext','$ntext','$userid','$atext','$ftext','$dtext','$ptext')";
   }
...
?>
        ...
        function cekDel(thecode)
        {
           ...
           document.formsubmit.action = "./Tbl_DocAdmin.php";
   	      ...
   	      <table width="760" border=0 cellpadding=0 cellspacing=0>
			  ...
			  <tr>
				<td style="padding-bottom:10px;padding-top:10px;">
					...
					Path : <input type="text" name="ptext" id="ptext" value="<?=$tpath?>" style="width:50px;margin-right:20px;">
...
<?
									$strsql="select * from Tbl_DocAdmin";
									$cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
