...
require ("../lib/open_con.php");
      ...
      $tsql = "DELETE FROM Tbl_Currency
   					WHERE curr_code='$thecode'";
...
require ("../lib/open_con.php");
   ...
   $tsql = "SELECT COUNT(*) as b FROM Tbl_Currency
   					WHERE curr_code='$ctext'";
   $cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
   $params = array(&$_POST['query']);
   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE Tbl_Currency SET curr_name = '$ntext',
											curr_flag = '$ftext',
											curr_active = '$atext',
											curr_create_userid = '$userid',
											curr_create_time = '$dtext'
											where curr_code = '$ctext'";
   }
   else
   {
      $tsql = "INSERT INTO Tbl_Currency VALUES('$ctext','$ntext','$ftext','$atext','$userid','$dtext')";
   }
...
?>
        ...
        function cekDel(thecode)
        {
           ...
           document.formsubmit.action = "./Tbl_Currency.php";
...
<?
	...
	$tsql = "SELECT * FROM Tbl_Currency
					WHERE curr_code='$thekey'";
	$cursorType = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
	$params = array(&$_POST['query']);
							...
							<center>
								...
								<table class="tablein" border="1">
									<tr align="center" height="20px">
										<th width="130px">Currency Code</th>
										<th width="193px">Currency Name</th>
										<th width="140px">Currency Flag</th>
										<th width="129px">Currency Active</th>
										<th width="135px"></th>
									</tr>
								</table>
								</div>
