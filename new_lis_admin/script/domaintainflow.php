   ...
   if ($rowcount > 0)
   {
      $tsql = "UPDATE OTO_Tbl_Workflow SET system_desc='$logdesc',
      				...
      				wf_rulesflow='$newrulesflow',
					    ...
					    wf_desc='$desc',
      				wf_backtoflow='$newbacktoflow'
      				WHERE wf_id='$newwfid'
      				AND system_userid='$userid'";
   }
   else
   {
      $tsql = "INSERT INTO OTO_Tbl_Workflow VALUES('$userid',convert(varchar,getdate(),121),'$logdesc',
                '$newwfid','$newwfname','$newwfurut','$newwftime','$newwfscore','$newwfact','$newproccode',
                '$newwfflag','$newwfdoc','$newprevflow','$newnextflow','$newrulesflow','$newparamdoc',
                '$desc','$newbacktoflow')";
   }
//echo $tsql;
      $params = array(&$_POST['query']);
...
//      					$tsql = "INSERT INTO Tbl_Workflow VALUES('$newwfid','$newwfname','$newwfurut','$newwftime','$newwfscore','$newwfact','$newproccode','$newwfflag','$desc')";
      					$tsql = "INSERT INTO Tbl_Workflow VALUES('$newwfid','$newwfname','$newwfurut','$newwftime','$newwfscore','$newwfact','$newproccode','$newwfflag','$desc');
                                CREATE TABLE [dbo].[Tbl_F$newwfid](
                            	[txn_id] [varchar](20) NULL,
                            	[txn_action] [varchar](10) NULL,
                            	[txn_time] [datetime] NULL,
                            	[txn_user_id] [varchar](30) NULL,
                            	[txn_changed_user_id] [varchar](30) NULL,
                            	[txn_notes] [varchar](100) NULL,
                            	[txn_branch_code] [varchar](10) NULL,
                            	[txn_region_code] [varchar](10) NULL
                                ) ON [PRIMARY]
                                ";
   					}
      				...
      				while( $row = sqlsrv_fetch_array( $sqlConn, SQLSRV_FETCH_ASSOC))
      				{
   					...
   					if ($rowcount > 0)
   					{
      					$tsql = "UPDATE Tbl_PrevFlow SET prev='$newprevflow',
      									...
      									BackTo='$newbacktoflow'
      								WHERE flow='$newwfid'";
   					}
	   				else
   					{
      					$tsql = "INSERT INTO Tbl_PrevFlow VALUES('$newwfid','$newprevflow','$newnextflow',
      					         '$newrulesflow','$newbacktoflow')";
   					}
      			$params = array(&$_POST['query']);
      			$stmt = sqlsrv_prepare( $conn, $tsql, $params);
      			if( $stmt )
